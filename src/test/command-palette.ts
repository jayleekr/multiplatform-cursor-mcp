...
async function testCommandPalette() {
    ...
    try {
        ...
        await windowsApi.openCommandPalette(cursorWindow as unknown as activeWin.Result)
        ...
        for (const char of text) {
            try {
                ...
                await windowsApi.simulateKeyboardEvent(cursorWindow as unknown as activeWin.Result, {
                    type: 'keyDown',
                    keyCode
                })
