...
export class PathResolver {
    private static readonly ALLOWED_PATH_PATTERN = /^[a-zA-Z0-9\-_./\\:\s]+$/
     ...
     */
    private static safeFileExists(filePath: string): boolean {
        try {
     ...
     */
    static validateWorkspacePath(userPath: string): string {
