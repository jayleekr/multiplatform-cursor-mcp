...
(function (Key) {
    ...
    Key[Key["Space"] = 109] = "Space";
    Key[Key["RightAlt"] = 110] = "RightAlt";
    Key[Key["RightSuper"] = 111] = "RightSuper";
    Key[Key["RightWin"] = 112] = "RightWin";
    Key[Key["RightCmd"] = 113] = "RightCmd";
    Key[Key["Menu"] = 114] = "Menu";
    Key[Key["RightControl"] = 115] = "RightControl";
    Key[Key["Fn"] = 116] = "Fn";
    Key[Key["Left"] = 117] = "Left";
    Key[Key["Down"] = 118] = "Down";
    Key[Key["Right"] = 119] = "Right";
    Key[Key["NumPad0"] = 120] = "NumPad0";
    Key[Key["Decimal"] = 121] = "Decimal";
    Key[Key["Clear"] = 122] = "Clear";
    Key[Key["AudioMute"] = 123] = "AudioMute";
    Key[Key["AudioVolDown"] = 124] = "AudioVolDown";
    Key[Key["AudioVolUp"] = 125] = "AudioVolUp";
    Key[Key["AudioPlay"] = 126] = "AudioPlay";
    Key[Key["AudioStop"] = 127] = "AudioStop";
    Key[Key["AudioPause"] = 128] = "AudioPause";
    Key[Key["AudioPrev"] = 129] = "AudioPrev";
    Key[Key["AudioNext"] = 130] = "AudioNext";
    Key[Key["AudioRewind"] = 131] = "AudioRewind";
    Key[Key["AudioForward"] = 132] = "AudioForward";
    Key[Key["AudioRepeat"] = 133] = "AudioRepeat";
    Key[Key["AudioRandom"] = 134] = "AudioRandom";
})(Key || (exports.Key = Key = {}));
